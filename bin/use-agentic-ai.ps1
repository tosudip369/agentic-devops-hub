# ==============================================================================
# use-agentic-ai v13.0.0 — The Autonomous Cutting-Edge Builder
# ==============================================================================
...
if ([string]::IsNullOrWhiteSpace($UserPrompt) -and $Mode -eq "build") {
    Write-Host ""
    Write-Host "  use-agentic-ai v13.0.0 — The Autonomous Builder" -ForegroundColor Cyan
...
if ($Mode -eq "status") {
    ...
    Write-Host "  │  🧠 Agentic DevOps Hub v13.0.0         │" -ForegroundColor Cyan
    Write-Host "  └─────────────────────────────────────┘" -ForegroundColor Cyan
    Write-Host ""
...
$BaseRules = @"
[DIR:v13.0.0] Arch:AgenticDevOpsHub
...
Write-Host ""
Write-Host "  🧠 [use-agentic-ai v13.0.0] Dispatching..." -ForegroundColor Cyan
