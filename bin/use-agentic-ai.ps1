# ==============================================================================
# use-agentic-ai v6.1.2 — The Autonomous Cutting-Edge Builder
# ==============================================================================
...
if ([string]::IsNullOrWhiteSpace($UserPrompt) -and $Mode -eq "build") {
    Write-Host ""
    Write-Host "  use-agentic-ai v6.1.2 — The Autonomous Builder" -ForegroundColor Cyan
...
if ($Mode -eq "status") {
    ...
    Write-Host "  │  🧠 Agentic DevOps Hub v6.1.2         │" -ForegroundColor Cyan
    Write-Host "  └─────────────────────────────────────┘" -ForegroundColor Cyan
    Write-Host ""
...
$BaseRules = @"
[DIR:v6.1.2] Arch:AgenticDevOpsHub
...
Write-Host ""
Write-Host "  🧠 [use-agentic-ai v6.1.2] Dispatching..." -ForegroundColor Cyan
