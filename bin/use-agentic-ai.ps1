# ==============================================================================
# use-agentic-ai v6.1.0 — The Autonomous Cutting-Edge Builder
# ==============================================================================
...
if ([string]::IsNullOrWhiteSpace($UserPrompt) -and $Mode -eq "build") {
    Write-Host ""
    Write-Host "  use-agentic-ai v6.1.0 — The Autonomous Builder" -ForegroundColor Cyan
...
if ($Mode -eq "status") {
    ...
    Write-Host "  │  🧠 Agentic DevOps Hub v6.1.0         │" -ForegroundColor Cyan
    Write-Host "  └─────────────────────────────────────┘" -ForegroundColor Cyan
    Write-Host ""
...
$BaseRules = @"
[DIR:v6.1.0] Arch:AgenticDevOpsHub
...
Write-Host ""
Write-Host "  🧠 [use-agentic-ai v6.1.0] Dispatching..." -ForegroundColor Cyan
