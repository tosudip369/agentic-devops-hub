# How to Use the Agentic DevOps Hub v4.0.0

This guide tells you exactly what commands to type to start using the Hub right now. With v4.0.0, everything revolves around the Universal Builder script.
